...
#define CONFIG_UI_SCROLL_DAMPING 20.0f
...
static void ui_scroll_widget_draw_func(ui_widget_t widget, uint32_t dt)
{
#if defined(CONFIG_UI_TOUCH_INTERFACE)
	ui_coord_t delta;
	ui_scroll_widget_body_t *body;
...
ui_widget_t ui_scroll_widget_create(int32_t width, int32_t height)
{
	...
	// default settings
	body->base.draw_cb = ui_scroll_widget_draw_func;
